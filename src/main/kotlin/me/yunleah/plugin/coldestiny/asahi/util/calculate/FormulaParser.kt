package me.yunleah.plugin.coldestiny.asahi.util.calculate

import me.yunleah.plugin.coldestiny.asahi.util.calculate.CalcOperator.Companion.isCalcOperator
import me.yunleah.plugin.coldestiny.asahi.util.calculate.CalcOperator.Companion.isCalcOperatorExceptRightBracket
import me.yunleah.plugin.coldestiny.asahi.util.calculate.CalcOperator.Companion.toCalcOperator
...
object FormulaParser {
    ...
    fun String.calculate(): Double {
        return runCatching {
            ...
            console().sendError("plugin-invalidFormula", this)
            0.0
        }
    }
}
